            ...
            <div class="col-12">
                <div class="clearfix d-flex justify-content-center">
                    <div id="js-filters-blog-posts" class="cbp-l-filters-button cbp-1-filters-alignCenter">
                        ...
                        <div data-filter=".Classic" class="cbp-filter-item">Thép</div>
                        <div data-filter=".Fantasy" class="cbp-filter-item">Gạch</div>
                        <div data-filter=".motion" class="cbp-filter-item">Ống nhựa</div>
                    </div>
                </div>
            </div>
            <!-- END FILTERS -->
