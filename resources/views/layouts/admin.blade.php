            ...
            <div class="dashboard">
                <div class="left">
                    ...
                    <div class="left__content">
                        <div class="left__logo">SHOP SHOES</div>
                        ...
                        <ul class="left__menu">
                            ...
                            <li class="left__menuItem">
                                ...
                                <div class="left__text">
                                    <a class="left__link" href="{{ route('category.create') }}">Thêm Loại</a>
                                    <a class="left__link" href="{{ route('category.index') }}">Xem Loại</a>
                                </div>
                            </li>
                            <li class="left__menuItem">
                            ...
                            <li class="left__menuItem">
                                ...
                                <div class="left__text">
                                    ...
                                    <a class="left__link" href="{{ route('discount.index') }}">Liệu kê danh sản phẩm</a>
                                </div>
                            </li>
                            <li class="left__menuItem">
